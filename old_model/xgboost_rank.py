...
class XgboostRank(object):
    ...
    def __init__(self, model_path, data_util):
        ...
        self.param = {'booster': 'gbtree', 'max_depth': 4, 'eta': 0.01, 'verbosity': 1, 'objective': 'rank:pairwise',
                      'gamma': 0.2, 'lambda': 500, 'subsample': 0.8, 'seed': 1, 'eval_metric': 'map@5'}
        self.num_round = 2000
    ...
    def cut_candidate(self, file_path, cut_candidate_path, max_num, is_train=False):
        ...
        for positive_index in positive_index_list:
            if positive_index in save_index_set:
                count += 1
        print(count, len(positive_index_list), "recall is: {0}".format(float(count) / len(positive_index_list)))
    ...
    def controller_train(self):
        train_path = "/home1/fangzheng/data/bert_el_data/wiki_clueweb/candidate/wiki_clueweb_rank_format"
        dev_path = "/home1/fangzheng/data/bert_el_data/aida_testB/candidate/aida_testB_rank_format"
        ...
        # cut_train_path = "/home1/fangzheng/data/bert_el_data/wiki_clueweb/candidate/wiki_clueweb_cut_rank_format"
    ...
    def controller_test(self):
        ...
        test_path = "/home1/fangzheng/data/bert_el_data/" + data_name + "/candidate/" + data_name + "_rank_format"
        cut_test_path = "/home1/fangzheng/data/bert_el_data/" + data_name + "/candidate/" + data_name + "_cut_rank_format"
    ...
    def controller_global_train(self):
        train_path = "/home1/fangzheng/data/bert_el_data/aida_train/candidate/aida_train_cut_rank_format"
        dev_path = "/home1/fangzheng/data/bert_el_data/aida_testB/candidate/aida_testB_cut_rank_format"
...
if __name__ == "__main__":
    model_path = "/home1/fangzheng/data/bert_el_data/xgboost/old_model/aida_train"
